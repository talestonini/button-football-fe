...
case object RankingAveragePositionShortToken extends Token("Md", "Avg")
case object RankingAveragePositionToken extends Token("Média", "Average")
...
case object RankingPointsShortToken extends Token("PR", "R Pts")
